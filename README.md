...
3. Скачиваем **mitmproxy**:
   * [https://www.mitmproxy.org](https://www.mitmproxy.org)
4. Устанавливаем
5. Запускаем **mitmweb** (веб-интерфейс - более удобен)
6. Устанавливаем сертификата
...
5. Перейти во вкладку **Flow List**
6. Очистить список:
   * **File -> Clear All**
7. (Опционально) Перезапустить Max.
